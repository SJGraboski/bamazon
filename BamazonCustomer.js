/* Bamazon Customer (assignment p1)
 * =============================== */
...
// make an order object for storing order details
var order = {
	id : -1,
	quantity: 0,
	price: 0,
...
/* NOTE
/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/		
 * Display Products acts as the first domino in our code.
 * Once it finishes, it will spur Purchase Item on.
 * That function will then initiate Purchase Quantity.
/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/ */
...
// flick the first domino that is displayProduct
displayProducts();